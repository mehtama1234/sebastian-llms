...
def _default_eval_pack_path() -> Path:
    # Topic-first layout: parents[4] is topics/; the eval pack lives beside this
    # build under the coding-agents topic.
    return Path(__file__).resolve().parents[4] / "coding-agents" / "evals" / "scenarios" / "core-v1.json"
