...
def test_meta_verifier_allowed_with_verifier():
    cfg = HarnessConfig("ok", verifier_enabled=True, meta_verifier_enabled=True)
    assert cfg.meta_verifier_enabled is True
