...
"$VENV_PYTHON" -m arch_adv_2026.compressed_attention_promotion_memo \
  ...
  --artifact-md "$ROOT_DIR/artifacts/reports/compressed-attention-promotion-memo.md" \
  --artifact-json "$ROOT_DIR/artifacts/reports/compressed-attention-promotion-memo.json" \
  --stdout
