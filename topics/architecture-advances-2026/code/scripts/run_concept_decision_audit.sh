...
"$VENV_PYTHON" -m arch_adv_2026.concept_decision_audit \
  ...
  --artifact-json "$ROOT_DIR/artifacts/reports/architecture-concept-decision-audit.json" \
  --artifact-md "$ROOT_DIR/artifacts/reports/architecture-concept-decision-audit.md" \
  --stdout
